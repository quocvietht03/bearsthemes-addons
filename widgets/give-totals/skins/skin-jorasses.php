	...
	public function register_design_give_form_section_controls( Widget_Base $widget ) {
			...
			[
				...
				'selectors' => [
					...
					'.give-form[data-style="elementor-give-totals--jorasses"] .give-total-wrap .give-currency-symbol,
					 ...
					 .give-form[data-style="elementor-give-totals--jorasses"] #give-final-total-wrap .give-donation-total-label,
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'bearsthemes-addons' ),
				'default' => '',
				'selector' => '.give-form[data-style="elementor-give-totals--jorasses"]',
			]
		);

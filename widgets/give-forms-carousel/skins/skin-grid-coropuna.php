	...
	public function register_design_give_form_section_controls(Widget_Base $widget) {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-forms-carousel--coropuna"] #give-donation-level-radio-list li input.give-default-level + label,
					.give-form[data-style="elementor-give-forms-carousel--coropuna"] #give-donation-level-radio-list li label:hover,
					.give-form[data-style="elementor-give-forms-carousel--coropuna"] #give-gateway-radio-list > li label:hover,
				 ...
				 .give-form[data-style="elementor-give-forms-carousel--coropuna"] #give-donation-level-radio-list li label:after,
				 .give-form[data-style="elementor-give-forms-carousel--coropuna"] #give-gateway-radio-list > li label:after,
				 ...
				 .give-form[data-style="elementor-give-forms-carousel--coropuna"] #give-final-total-wrap .give-donation-total-label,
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'bearsthemes-addons' ),
				'default' => '',
				'selector' => '.give-form[data-style="elementor-give-forms-carousel--coropuna"]',
			]
		);
      	...
      	<div class="swiper-slide">
	  		<article id="post-<?php the_ID();  ?>" <?php post_class( $form_class ); ?> >
				...
				<?php
					...
					the_terms( $post_id, 'give_posts_category', '<div class="give-card__category">' . bearsthemes_addons_get_icon_svg( 'location', 14 ) , ', ', '</div>' );
					}
